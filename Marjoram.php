...
<head>
    ...
    <title>Sutharise Exports And Imports - Marjoram</title>
    ...
    <style>
        .page-header {
            position: relative;
            background: url('assets/images/Marjoram.jpg') no-repeat center center;
...
<body>
    ...
    <div class="container-fluid bg-light product-section" id="product-marjoram">
        <div class="container">
            <div class="row align-items-center">
                <!-- Product Image -->
                <div class="col-md-6 mb-4 mb-md-0" data-aos="fade-right">
                    <img src="assets/images/Marjoram.jpg" alt="Marjoram Herb" class="product-image">
                </div>

                <!-- Product Content -->
                <div class="col-md-6 product-details" data-aos="fade-left">
                    <h2>Fresh Marjoram Herb</h2>
                    <p>Our <strong>fresh Marjoram herbs</strong> are carefully cultivated and harvested to provide a fragrant and flavorful addition to your culinary and medicinal uses. Known for their aromatic leaves and subtle flavor, these herbs are perfect for cooking, teas, and natural remedies.</p>

                    <ul>
                        <li>Fresh, aromatic leaves with rich flavor</li>
                        <li>Perfect for culinary, teas, and medicinal purposes</li>
                        <li>Handpicked and hygienically packed</li>
                        <li>Maintains natural freshness and aroma</li>
                        <li>Grown using sustainable farming methods</li>
                    </ul>
