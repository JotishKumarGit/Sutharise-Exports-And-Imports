...
<head>
    ...
    <title>Sutharise Exports And Imports - Rose</title>
    ...
    <style>
        .page-header {
            position: relative;
            background: url('assets/images/Rose.jpg') no-repeat center center;
...
<body>
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Rose</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <div class="container-fluid bg-light product-section" id="product-rose">
        <div class="container">
            <div class="row align-items-center">
                <!-- Product Image -->
                <div class="col-md-6 mb-4 mb-md-0" data-aos="fade-right">
                    <img src="assets/images/Rose.jpg" alt="Rose Flower" class="product-image">
                </div>

                <!-- Product Content -->
                <div class="col-md-6 product-details" data-aos="fade-left">
                    <h2>Fresh Rose Flowers</h2>
                    <p>Our <strong>fresh rose flowers</strong> are handpicked to provide the highest quality, fragrance, and vibrancy. Ideal for bouquets, decorations, essential oils, and ceremonial purposes, these roses are cultivated with care to maintain their natural beauty.</p>

                    <ul>
                        <li>Bright and fragrant blooms</li>
                        <li>Perfect for decoration, bouquets, and rituals</li>
                        <li>Handpicked and hygienically packed</li>
                        <li>Long-lasting freshness and natural fragrance</li>
                        <li>Grown under sustainable and organic practices</li>
                    </ul>
