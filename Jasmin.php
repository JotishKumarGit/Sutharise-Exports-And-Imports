...
<head>
    ...
    <title>Sutharise Exports And Imports - Jasmin</title>
    ...
    <style>
        .page-header {
            position: relative;
            background: url('assets/images/Jasmin.jpg') no-repeat center center;
...
<body>
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Jasmin</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <div class="container-fluid bg-light product-section" id="product-jasmin">
        <div class="container">
            <div class="row align-items-center">
                <!-- Product Image -->
                <div class="col-md-6 mb-4 mb-md-0" data-aos="fade-right">
                    <img src="assets/images/Jasmin.jpg" alt="Jasmin Flower" class="product-image">
                </div>

                <!-- Product Content -->
                <div class="col-md-6 product-details" data-aos="fade-left">
                    <h2>Fresh Jasmin Flowers</h2>
                    <p>Our <strong>fresh Jasmin flowers</strong> are handpicked to ensure purity, fragrance, and long-lasting freshness. Perfect for garlands, perfumes, religious offerings, and decorative purposes, these flowers are cultivated under natural conditions for premium quality.</p>

                    <ul>
                        <li>Delicate and aromatic white blossoms</li>
                        <li>Ideal for garlands, decoration, and rituals</li>
                        <li>Handpicked and hygienically packed</li>
                        <li>Maintains natural fragrance for longer duration</li>
                        <li>Grown using sustainable and organic methods</li>
                    </ul>
